...
class tembisController extends Controller
{
    ...
    {   
        ...
        {
            $sksp = session('sksp');
            $data_konbis = data_konbis::where('jenis_sp', 'LIKE', $data_id . '%')->where('skema_sp', 'LIKE', $sksp . '%')->get();
    ...
    public function sortsksp($data_id)
    {
        ...
        {
            $jsp = session('jsp');
            $data_konbis = data_konbis::where('jenis_sp', 'LIKE', $jsp . '%')->where('skema_sp', 'LIKE', $data_id . '%')->get();
